...
//    component.setBackground(getBackground()); // use same background color.
...
//
// drawPolygon is documented to draw a *CLOSED* polygon, but here we want an open one
...
// fillPolygon doesn't quite get everything in Apple MRJ 1.5b1 appletViewer [DE]
g.drawLine(edges[0][tabN-2],edges[1][tabN-2],edges[0][tabN-1],edges[1][tabN-1]);
    g.setColor(getForeground());
//    g.drawPolygon(edges[0],edges[1],tabN-1); // leave off corner on outline!
