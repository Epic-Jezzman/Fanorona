...
public class Hash {
	...
	public static final int DEPTH_ADJUSTMENT = 40;	// hack to make neg depth work
	...
	public final int hashKey(Board b) {
		long n = b.myPieces * 0x9910602f496efed1L + b.opponentPieces * 0xb3ac55ca1f3c7538L;
...
//		return (int) ((n * 0x1121400305112141L) >>> (64 - hashSize));
	...
	public final boolean getHash(Board board, int key, int alpha, int beta, int depth) {
		key <<= 2;
		if (table[key] == board.myPieces && table[key+1] == board.opponentPieces) {
			...
			if (evalDepth < depth) { if (COLLECT_STATISTICS) shallow++; }
